...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Iosevka Nerd Font Mono Light"
                               :size 12
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
